        ...
        if template_name == 'app_monetization_stats':
            if df.index[id] == 'diff, %':
                rows_dict: dict = {
                    ...
                    # temp
                    'installs': f"""{Decimal(f"{df['installs'].iloc[id]:.2g}"):f}%""",
                ...
                rows_dict: dict = {
                    ...
                    'installs': int(df['installs'].iloc[id]),
            ...
            if df.index[id] == 'pvalue':
                rows_dict: dict = {
                    ...
                    'install cr, %_color': self.generate_metric_color(df['install cr, %'].iloc[id], df['install cr, %'].iloc[id - 1]),
                    ...
                    'install cr, %': f"{self.pvalue_round(df['install cr, %'].iloc[id])}",
                ...
                rows_dict: dict = {
                    ...
                    'install cr, %': self.generate_image_markup(f'install cr, %_pvalues_diff_confidence_intervals_{calc_session}.png'),
                ...
                rows_dict: dict = {
                    ...
                    'install cr, %': f"""{Decimal(f"{df['install cr, %'].iloc[id]:.3g}"):f}%""",
